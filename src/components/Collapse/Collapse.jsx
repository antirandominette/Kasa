...
function Collapse({ id, title, description, equipements, IsOpen }) {
    ...
    return(
        <>
            <div key={ id } onClick={ handleClick } className="collapseBody noSelect flexRow" >
                <h2 className='collapseTitle'>{ title }</h2>
                <svg className={ open ? "collapseArrow open" : "collapseArrow" } viewBox="0 0 25 15" fill="none" xmlns="http://www.w3.org/2000/svg">
